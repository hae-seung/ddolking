...
[CreateAssetMenu(fileName = "SwordFallPattern", menuName = "Entity/Boss/Pattern/SwordFall")]
public class SwordFallPattern : BossPattern
{ 
    ...
    {
        List<SwordPos> swordPosPatterns = SpringSpawner.Instance.swordPosPatterns;
